...
namespace YayPricingScoped\YayCommerce\AdminShell\Registry;
...
class LicenseRegistry
{
    ...
    public function all(): array
    {
        ...
        $old_plugins = [];
        $handlers = ['YayPricingScoped\YAYDP\License\License_Handler', 'YayPricingScoped\YayMail\License\LicenseHandler', 'YayPricingScoped\Yay_Currency\License\LicenseHandler', 'YayPricingScoped\Yay_Swatches\License\LicenseHandler', 'YayPricingScoped\YayExtra\License\LicenseHandler', 'YayPricingScoped\YayRev\License\LicenseHandler', 'YayPricingScoped\YayWholesaleB2B\License\LicenseHandler', 'YayPricingScoped\YaySMTP\License\LicenseHandler'];
