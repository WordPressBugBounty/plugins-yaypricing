...
namespace YayPricingScoped\YayCommerce\AdminShell\License;

use YayPricingScoped\YayCommerce\AdminShell\License\Contracts\LicenseConfigAdapter;
use YayPricingScoped\YayCommerce\AdminShell\Support\Slug;
...
class LicenseHandler
{
    ...
    public static function remove_site_plugin_check(LicenseConfigAdapter $adapter): void
    {
        ...
        if (!function_exists('YayPricingScoped\get_plugin_data')) {
