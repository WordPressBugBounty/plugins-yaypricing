...
namespace YayPricingScoped\YayCommerce\AdminShell\Pages;
...
class RecommendedPluginsPage
{
    ...
    {
        if (function_exists('YayPricingScoped\WC')) {
    ...
    public static function enqueue_scripts(): void
    {
        ...
        wp_localize_script('yaycommerce-other-plugins', 'yayRecommended', ['nonce' => wp_create_nonce('yay_recommended_nonce'), 'admin_ajax' => admin_url('admin-ajax.php'), 'woo_active' => function_exists('YayPricingScoped\WC')]);
