<?php
/**
 * Other plugins data — ported from YayMail Pro OtherPluginsMenu::get_other_plugins().
 * Returns array used by RecommendedPluginsPage::get_other_plugins().
 *
...
return [
    ...
    'yayswatches'                            => [
        ...
        'short_description' => 'Optimize your variable product showcase with color swatches, image swatches, and more.',
    ...
    'yayextra'                               => [
        ...
        'short_description' => 'Add WooCommerce product options like engraving, print-on-demand, gifts, and more.',
    ...
    'yaypricing'                             => [
        ...
        'short_description' => 'Offer automatic pricing and discounts for your WooCommerce store.',
    ...
    'yay-wholesale-b2b'                      => [
        ...
        'short_description' => 'A powerful plugin that allows you to sell to wholesale customers and businesses.',
    ...
    'yayboost-sales-booster-for-woocommerce' => [
        ...
        'icon'              => 'https://ps.w.org/yayboost-sales-booster-for-woocommerce/assets/icon-256x256.png?rev=3498248',
