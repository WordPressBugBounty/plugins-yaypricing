    ...
    <header>
        <div class="yaycommerce-license__top-bar">
            ...
            <div class="yaycommerce-license__top-bar__title">
                <h2><?php esc_html_e( 'Activate Licenses', 'yaycommerce' ); ?></h2>
            </div>
            <?php
            ...
            foreach ( $licensing_plugins as $plugin ) {
                ...
                if ( empty( $key ) || empty( $info ) || 'expired' === ( $info['license'] ?? '' ) ) {
                    $has_inactive_license = true;
                    break;
                }
            }
            ?>
            <div class="yaycommerce-license__important-notice" data-display="<?php echo $has_inactive_license ? 'true' : 'false'; ?>" style="<?php echo $has_inactive_license ? '' : 'display:none;'; ?>">
                ...
                <span>
                    <strong><?php esc_html_e( 'Important notice:', 'yaycommerce' ); ?> </strong>
                    <span><?php esc_html_e( 'Please activate your license to start using the Pro version', 'yaycommerce' ); ?></span>
                </span>
            </div>
        </div>
    </header>
    <main>
        <?php if ( ! empty( $is_network ) ) : ?>
        <div class="yaycommerce-license__network-notice">
            <span>
                <strong><?php esc_html_e( 'Network Admin:', 'yaycommerce' ); ?> </strong>
                <?php esc_html_e( 'License keys are managed per site. Activate each plugin license from the individual site\'s dashboard.', 'yaycommerce' ); ?>
            </span>
        </div>
        <?php endif; ?>
        <div class="message message--success" id="message-activate-success">
            ...
            <p class="message__text"><?php esc_html_e( 'Activated', 'yaycommerce' ); ?></p>
        </div>
        <div class="message message--error" id="message-activate-error">
            ...
            <p class="message__text"><?php esc_html_e( 'Activate failed', 'yaycommerce' ); ?></p>
        </div>
        <div class="message message--success" id="message-update-success">
            <svg viewBox="64 64 896 896" focusable="false" data-icon="check-circle" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm193.5 301.7l-210.6 292a31.8 31.8 0 01-51.7 0L318.5 484.9c-3.8-5.3 0-12.7 6.5-12.7h46.9c10.2 0 19.9 4.9 25.9 13.3l71.2 98.8 157.2-218c6-8.3 15.6-13.3 25.9-13.3H699c6.5 0 10.3 7.4 6.5 12.7z"></path></svg>
            <p class="message__text"><?php esc_html_e( 'Updated', 'yaycommerce' ); ?></p>
        </div>
        <div class="message message--error" id="message-update-error">
            <svg viewBox="64 64 896 896" focusable="false" data-icon="close-circle" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm165.4 618.2l-66-.3L512 563.4l-99.3 118.4-66.1.3c-4.4 0-8-3.5-8-8 0-1.9.7-3.7 1.9-5.2l130.1-155L340.5 359a8.32 8.32 0 01-1.9-5.2c0-4.4 3.6-8 8-8l66.1.3L512 464.6l99.3-118.4 66-.3c4.4 0 8 3.5 8 8 0 1.9-.7 3.7-1.9 5.2L553.5 514l130 155c1.2 1.5 1.9 3.3 1.9 5.2 0 4.4-3.6 8-8 8z"></path></svg>
            <p class="message__text"><?php esc_html_e( 'Updated failed', 'yaycommerce' ); ?></p>
        </div>
        <div class="message message--success" id="message-remove-success">
            <svg viewBox="64 64 896 896" focusable="false" data-icon="check-circle" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm193.5 301.7l-210.6 292a31.8 31.8 0 01-51.7 0L318.5 484.9c-3.8-5.3 0-12.7 6.5-12.7h46.9c10.2 0 19.9 4.9 25.9 13.3l71.2 98.8 157.2-218c6-8.3 15.6-13.3 25.9-13.3H699c6.5 0 10.3 7.4 6.5 12.7z"></path></svg>
            <p class="message__text"><?php esc_html_e( 'Removed', 'yaycommerce' ); ?></p>
        </div>
        <div class="message message--error" id="message-remove-error">
            <svg viewBox="64 64 896 896" focusable="false" data-icon="close-circle" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm165.4 618.2l-66-.3L512 563.4l-99.3 118.4-66.1.3c-4.4 0-8-3.5-8-8 0-1.9.7-3.7 1.9-5.2l130.1-155L340.5 359a8.32 8.32 0 01-1.9-5.2c0-4.4 3.6-8 8-8l66.1.3L512 464.6l99.3-118.4 66-.3c4.4 0 8 3.5 8 8 0 1.9-.7 3.7-1.9 5.2L553.5 514l130 155c1.2 1.5 1.9 3.3 1.9 5.2 0 4.4-3.6 8-8 8z"></path></svg>
            <p class="message__text"><?php esc_html_e( 'Removed failed', 'yaycommerce' ); ?></p>
        </div>
                    ...
                    <div class="yaycommerce-license-settings">
                        <div class="yaycommerce-license-card yaycommerce-license-no-license">
                            <div class="yaycommerce-license-card-body">
                                ...
                                printf(
                                    wp_kses(
                                        __( 'Welcome to YayCommerce! Please visit our website to get more <a href="%s" target="_blank">WooCommerce plugins</a>.', 'yaycommerce' ),
                                        [ 'a' => [ 'href' => [], 'target' => [] ] ]
                                    ),
                                    'https://yaycommerce.com/'
                                );
                                ?>
                            </div>
                        </div>
                    ...
                    <div class="yaycommerce-license-sidebar-sticky">
                        <div class="yaycommerce-license-card yaycommerce-license__getting-started">
                            <div class="yaycommerce-license-card-header">
                                <h3><?php esc_html_e( 'Getting Started (How to find license keys)', 'yaycommerce' ); ?></h3>
                            </div>
                            <div class="yaycommerce-license-card-body">
                                <p><?php esc_html_e( 'Please follow the steps below:', 'yaycommerce' ); ?></p>
                                <ul class="yaycommerce-license__task-list">
                                    <li>
                                        ...
                                        <span><?php esc_html_e( 'Log in to your', 'yaycommerce' ); ?> <a href="https://yaycommerce.com/dashboard" target="_blank" rel="noopener">YayCommerce Dashboard</a></span>
                                    </li>
                                    <li>
                                        ...
                                        <span><?php esc_html_e( 'Go to', 'yaycommerce' ); ?> <strong><?php esc_html_e( 'License Keys', 'yaycommerce' ); ?></strong> <?php esc_html_e( 'tab', 'yaycommerce' ); ?></span>
                                    </li>
                                    <li>
                                        ...
                                        <span><?php esc_html_e( 'Copy your license key and paste it in this License tab', 'yaycommerce' ); ?></span>
                                    </li>
                                    <li>
                                        ...
                                        <span><?php esc_html_e( 'Click Activate - you\'re all set!', 'yaycommerce' ); ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="yaycommerce-license-card yaycommerce-license__benefits">
                            <div class="yaycommerce-license-card-header">
                                <h3><?php esc_html_e( "What you'll get when activating license:", 'yaycommerce' ); ?></h3>
                            </div>
                            <div class="yaycommerce-license-card-body">
                                <ul class="yaycommerce-license__task-list">
                                    <li>
                                        ...
                                        <span><?php esc_html_e( 'Start using the Pro version', 'yaycommerce' ); ?></span>
                                    </li>
                                    <li>
                                        <span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 1.25C5.16797 1.25 1.25 5.16797 1.25 10C1.25 14.832 5.16797 18.75 10 18.75C14.832 18.75 18.75 14.832 18.75 10C18.75 5.16797 14.832 1.25 10 1.25ZM13.7793 7.14258L9.66602 12.8457C9.60853 12.9259 9.53274 12.9913 9.44493 13.0364C9.35713 13.0815 9.25984 13.1051 9.16113 13.1051C9.06242 13.1051 8.96513 13.0815 8.87733 13.0364C8.78953 12.9913 8.71374 12.9259 8.65625 12.8457L6.2207 9.4707C6.14648 9.36719 6.2207 9.22266 6.34766 9.22266H7.26367C7.46289 9.22266 7.65234 9.31836 7.76953 9.48242L9.16016 11.4121L12.2305 7.1543C12.3477 6.99219 12.5352 6.89453 12.7363 6.89453H13.6523C13.7793 6.89453 13.8535 7.03906 13.7793 7.14258Z" fill="#52C41A"></path></svg></span>
                                        <span><?php esc_html_e( 'Auto-update to the latest version', 'yaycommerce' ); ?></span>
                                    </li>
                                    <li>
                                        <span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 1.25C5.16797 1.25 1.25 5.16797 1.25 10C1.25 14.832 5.16797 18.75 10 18.75C14.832 18.75 18.75 14.832 18.75 10C18.75 5.16797 14.832 1.25 10 1.25ZM13.7793 7.14258L9.66602 12.8457C9.60853 12.9259 9.53274 12.9913 9.44493 13.0364C9.35713 13.0815 9.25984 13.1051 9.16113 13.1051C9.06242 13.1051 8.96513 13.0815 8.87733 13.0364C8.78953 12.9913 8.71374 12.9259 8.65625 12.8457L6.2207 9.4707C6.14648 9.36719 6.2207 9.22266 6.34766 9.22266H7.26367C7.46289 9.22266 7.65234 9.31836 7.76953 9.48242L9.16016 11.4121L12.2305 7.1543C12.3477 6.99219 12.5352 6.89453 12.7363 6.89453H13.6523C13.7793 6.89453 13.8535 7.03906 13.7793 7.14258Z" fill="#52C41A"></path></svg></span>
                                        <span><?php esc_html_e( 'Get bug fixes and security updates fastest', 'yaycommerce' ); ?></span>
                                    </li>
                                    <li>
                                        <span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 1.25C5.16797 1.25 1.25 5.16797 1.25 10C1.25 14.832 5.16797 18.75 10 18.75C14.832 18.75 18.75 14.832 18.75 10C18.75 5.16797 14.832 1.25 10 1.25ZM13.7793 7.14258L9.66602 12.8457C9.60853 12.9259 9.53274 12.9913 9.44493 13.0364C9.35713 13.0815 9.25984 13.1051 9.16113 13.1051C9.06242 13.1051 8.96513 13.0815 8.87733 13.0364C8.78953 12.9913 8.71374 12.9259 8.65625 12.8457L6.2207 9.4707C6.14648 9.36719 6.2207 9.22266 6.34766 9.22266H7.26367C7.46289 9.22266 7.65234 9.31836 7.76953 9.48242L9.16016 11.4121L12.2305 7.1543C12.3477 6.99219 12.5352 6.89453 12.7363 6.89453H13.6523C13.7793 6.89453 13.8535 7.03906 13.7793 7.14258Z" fill="#52C41A"></path></svg></span>
                                        <span><?php esc_html_e( 'Custom CSS & theme tweaks upon requests', 'yaycommerce' ); ?></span>
                                    </li>
                                    <li>
                                        <span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 1.25C5.16797 1.25 1.25 5.16797 1.25 10C1.25 14.832 5.16797 18.75 10 18.75C14.832 18.75 18.75 14.832 18.75 10C18.75 5.16797 14.832 1.25 10 1.25ZM13.7793 7.14258L9.66602 12.8457C9.60853 12.9259 9.53274 12.9913 9.44493 13.0364C9.35713 13.0815 9.25984 13.1051 9.16113 13.1051C9.06242 13.1051 8.96513 13.0815 8.87733 13.0364C8.78953 12.9913 8.71374 12.9259 8.65625 12.8457L6.2207 9.4707C6.14648 9.36719 6.2207 9.22266 6.34766 9.22266H7.26367C7.46289 9.22266 7.65234 9.31836 7.76953 9.48242L9.16016 11.4121L12.2305 7.1543C12.3477 6.99219 12.5352 6.89453 12.7363 6.89453H13.6523C13.7793 6.89453 13.8535 7.03906 13.7793 7.14258Z" fill="#52C41A"></path></svg></span>
                                        <span><?php esc_html_e( 'Premium technical support', 'yaycommerce' ); ?></span>
                                    </li>
                                    <li>
                                        <span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 1.25C5.16797 1.25 1.25 5.16797 1.25 10C1.25 14.832 5.16797 18.75 10 18.75C14.832 18.75 18.75 14.832 18.75 10C18.75 5.16797 14.832 1.25 10 1.25ZM13.7793 7.14258L9.66602 12.8457C9.60853 12.9259 9.53274 12.9913 9.44493 13.0364C9.35713 13.0815 9.25984 13.1051 9.16113 13.1051C9.06242 13.1051 8.96513 13.0815 8.87733 13.0364C8.78953 12.9913 8.71374 12.9259 8.65625 12.8457L6.2207 9.4707C6.14648 9.36719 6.2207 9.22266 6.34766 9.22266H7.26367C7.46289 9.22266 7.65234 9.31836 7.76953 9.48242L9.16016 11.4121L12.2305 7.1543C12.3477 6.99219 12.5352 6.89453 12.7363 6.89453H13.6523C13.7793 6.89453 13.8535 7.03906 13.7793 7.14258Z" fill="#52C41A"></path></svg></span>
                                        <span><?php esc_html_e( 'Live Chat 1-1 for any questions', 'yaycommerce' ); ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
