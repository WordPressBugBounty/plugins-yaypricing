...
?>
<div class="yaycommerce-license-card" id="<?php echo esc_attr( "{$plugin_slug}_license_card" ); ?>">
    ...
    <div class="yaycommerce-license-card-body">
        ...
        <div class="yaycommerce-license-input-row">
            <input type="password" autocomplete="new-password" id="<?php echo esc_attr( "{$plugin_slug}_license_input" ); ?>" placeholder="<?php esc_attr_e( 'License key', 'yaycommerce' ); ?>">
            <button class="button button-primary yaycommerce-license-button yaycommerce-activate-license-button" data-plugin="<?php echo esc_attr( $plugin_slug ); ?>">
                <span><?php esc_html_e( 'Activate License', 'yaycommerce' ); ?></span>
