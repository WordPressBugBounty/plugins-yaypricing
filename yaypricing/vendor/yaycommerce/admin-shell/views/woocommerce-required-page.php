...
<div class="yaycommerce-requirement-screen">
	<div class="yaycommerce-requirement-card">
		<div class="yaycommerce-requirement-card__icon" aria-hidden="true"><?php echo esc_html( $copy['icon'] ); ?></div>
		<h1 class="yaycommerce-requirement-card__title"><?php echo esc_html( $copy['title'] ); ?></h1>
		<p class="yaycommerce-requirement-card__text"><?php echo esc_html( $copy['text'] ); ?></p>
		<a class="yaycommerce-requirement-card__button" href="<?php echo esc_url( $yaycommerce_install_wc_url ); ?>">
			<?php echo esc_html( $copy['button'] ); ?>
		</a>
		<p class="yaycommerce-requirement-card__hint"><?php echo esc_html( $copy['hint'] ); ?></p>
	</div>
</div>
