...
namespace YayCommerce\AdminShell\Menu;

use YayCommerce\AdminShell\Pages\LicensesPage;
use YayCommerce\AdminShell\Pages\RecommendedPluginsPage;
use YayCommerce\AdminShell\Pages\HelpPage;
...
class PagesRouter {
    ...
    private function get_submenus(): array {
        ...
        $submenus['yaycommerce-help'] = [
            ...
            'render_callback' => [ HelpPage::class, 'render' ],
            'load_callback'   => [ HelpPage::class, 'load_data' ],
            'position'        => 900,
        ];
        ...
        if ( $has_any ) {
            $submenus['yaycommerce-licenses'] = [
                ...
                'capability'      => $capability,
                'render_callback' => [ LicensesPage::class, 'render' ],
                'load_callback'   => [ LicensesPage::class, 'load_data' ],
                'position'        => 910,
            ];
        }
        ...
        $submenus['yaycommerce-other-plugins'] = [
            'parent'          => 'yaycommerce',
            'name'            => __( 'Recommended Plugins', 'yaycommerce' ),
            'capability'      => $capability,
            'render_callback' => [ RecommendedPluginsPage::class, 'render' ],
            'load_callback'   => [ RecommendedPluginsPage::class, 'load_data' ],
            'position'        => 920,
        ];
