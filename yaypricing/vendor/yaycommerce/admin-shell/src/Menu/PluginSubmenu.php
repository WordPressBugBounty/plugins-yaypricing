...
use YayCommerce\AdminShell\Pages\WooCommerceRequiredPage;
...
class PluginSubmenu {
    ...
    public function register(): void {
        ...
        if ( ! $needs_redirect
            && method_exists( $this->adapter, 'needs_woocommerce_screen' )
            && $this->adapter->needs_woocommerce_screen() ) {
            $screen_copy = method_exists( $this->adapter, 'get_woocommerce_screen_copy' )
                ? (array) $this->adapter->get_woocommerce_screen_copy()
                : [];
