...
class WooCommerceRequiredPage {
    ...
    private static function defaults(): array {
        return [
            'icon'   => '🛒',
            'title'  => __( 'WooCommerce is required', 'yaycommerce' ),
            'text'   => __( 'This plugin extends WooCommerce, so it needs WooCommerce installed and activated. Install WooCommerce to get started.', 'yaycommerce' ),
            'button' => __( 'Install WooCommerce', 'yaycommerce' ),
            'hint'   => __( 'Already installed it? Activate WooCommerce, then reload this page.', 'yaycommerce' ),
        ];
    }
}
