...
namespace YayCommerce\AdminShell\Pages;
...
class RecommendedPluginsPage {
            ...
            <div class="yay-recommended-plugins-layout">
                <div class="yay-recommended-plugins-layout-header">
                    <div class="wp-filter yay-recommended-plugins-header">
                        <h2 class="yay-recommended-plugins-header-title"><?php esc_attr_e( 'Recommended Plugins', 'yaycommerce' ); ?></h2>
                        <ul class="filter-links">
                            <?php echo wp_kses_post( $featured_tab ); ?>
                            <li class="plugin-install-tab plugin-install-all" data-tab="all"><a href="#">All</a></li>
                            <?php echo wp_kses_post( $woo_tab ); ?>
    ...
    public static function enqueue_scripts(): void {
        ...
        wp_enqueue_style(
            ...
            $assets_url . 'css/other-plugins.css',
            [],
            '1.0'
        );
        wp_register_script(
            'yaycommerce-other-plugins',
            $assets_url . 'js/other-plugins.js',
            [ 'jquery' ],
            '1.0',
            true
        );
    ...
    public function ajax_get_plugin_data(): void {
        try {
            ...
            foreach ( $recommended_data as $key => $plugin ) {
                if ( in_array( $tab, $plugin['type'], true ) || 'all' === $tab ) {
    ...
    public function check_pro_version_exists( array $plugin_detail ): ?string {
        ...
        $map         = [
            'filebird'                               => [ 'filebird-pro/filebird.php' ],
            'yaymail'                                => [ 'yaymail-pro/yaymail.php', 'email-customizer-for-woocommerce/yaymail.php' ],
            'yaycurrency'                            => [ 'yaycurrency-pro/yay-currency.php', 'multi-currency-switcher/yay-currency.php' ],
            'yaysmtp'                                => [ 'yaysmtp-pro/yay-smtp.php' ],
            'yayswatches'                            => [ 'yayswatches-pro/yay-swatches.php' ],
            'yayextra'                               => [ 'yayextra-pro/yayextra.php' ],
            'yaypricing'                             => [ 'yaypricing-pro/yaypricing.php', 'dynamic-pricing-discounts/yaypricing.php' ],
            'yay-customer-reviews-woocommerce'       => [ 'yayreviews-pro/yay-customer-reviews-woocommerce.php' ],
            'yay-wholesale-b2b'                      => [ 'yay-wholesale-b2b-pro/yay-wholesale-b2b.php' ],
            'yayboost-sales-booster-for-woocommerce' => [ 'yayboost-pro/yayboost-sales-booster-for-woocommerce.php' ],
            'cf7-multi-step'                         => [ 'contact-form-7-multi-step-pro/contact-form-7-multi-step.php' ],
            'cf7-database'                           => [ 'contact-form-7-database-pro/cf7-database.php' ],
            'wp-whatsapp'                            => [ 'whatsapp-for-wordpress/whatsapp.php' ],
        ];
