...
namespace YayCommerce\AdminShell\Registry;
...
class AddonLicenseAdapter implements LicenseConfigAdapter {
    ...
    public function get_plugin_name(): string { return $this->name; }
    public function get_plugin_version(): string { return ''; }
    public function get_plugin_file(): string { return $this->file; }
    public function get_item_id(): int { return $this->item_id; }
    public function get_store_url(): string { return $this->store_url; }
    public function get_store_link(): string { return $this->url; }
    public function get_menu_title(): string { return $this->name; }
    public function get_page_title(): string { return $this->name; }
    ...
    public function get_plugin_basename(): string { return $this->basename; }
    public function get_settings_label(): string { return ''; }
