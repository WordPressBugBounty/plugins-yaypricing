...
class LicenseRegistry {
    ...
    public function all(): array {
        ...
        $handlers = [
            '\YAYDP\License\License_Handler',
            '\YayMail\License\LicenseHandler',
            '\Yay_Currency\License\LicenseHandler',
            '\Yay_Swatches\License\LicenseHandler',
            '\YayExtra\License\LicenseHandler',
            '\YayRev\License\LicenseHandler',
            '\YayWholesaleB2B\License\LicenseHandler',
            '\YaySMTP\License\LicenseHandler',
        ];
